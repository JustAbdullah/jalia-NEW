...
class ListOfCvSearchingName extends StatelessWidget {
  const ListOfCvSearchingName({super.key});

  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    return FutureBuilder(
        future: homeController.SearchNameCv(
            homeController.theNameSearchingCv.toString()),
