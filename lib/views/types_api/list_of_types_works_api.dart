...
class ListOfTypesWorksApi extends StatelessWidget {
  const ListOfTypesWorksApi({super.key});

  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    return FutureBuilder(
        future: homeController.getTypesWorksFromDatabase(),
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  snapshot.data['data'][i]['name_type_work'],
                                  style: TextStyle(
                                    height: 1,
