...
class ListOfBusiness extends StatelessWidget {
  const ListOfBusiness({super.key});

  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    return FutureBuilder(
        future: homeController.getCopmenyFromDatabase(),
                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (context, i) {
                      return Padding(
                          ...
                          child: InkWell(
                              onTap: () async {
                                homeController.business.business_directory_id =
                                ...
                                homeController.business
                                    ...
                                    snapshot.data['data'][i]
                                        ...
                                        .toString();
                                homeController
                                        .business.business_directory_add_by =
                                    snapshot.data['data'][i]
                                ...
                                homeController.business.id_palce = snapshot
                                    ...
                                    .toString();
                                homeController.business.name_id_place = snapshot
