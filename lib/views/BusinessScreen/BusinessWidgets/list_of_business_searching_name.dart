...
class ListOfBusinessSearchingName extends StatelessWidget {
  const ListOfBusinessSearchingName({super.key});

  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    return FutureBuilder(
        future: homeController.SearchNameCompeny(
            homeController.theNameSearchingCompeny.toString()),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            return homeController.IsHaveDataCompenyNameSearch.value == false
                ? Center(
                    child: Column(
