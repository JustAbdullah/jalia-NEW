...
class ListOfWorksSearchingByName extends StatelessWidget {
  const ListOfWorksSearchingByName({super.key});

  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    return FutureBuilder(
        future: homeController.SearchNameWork(
            homeController.theNameSearchingWork.toString()),
          ...
          if (snapshot.hasData) {
            return PaddingCustom(
              ...
              child: Container(
                ...
                child: homeController.IsHaveDataWorkNameSearch.value == false
                    ? Center(
                        child: Column(
