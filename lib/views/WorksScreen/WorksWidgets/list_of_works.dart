...
class ListOfWorks extends StatelessWidget {
  const ListOfWorks({super.key});

  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    return FutureBuilder(
        future: homeController.getWorksFromDatabase(),
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    return PaddingCustom(
                      ...
                      child: InkWell(
                        onTap: () {
                          homeController.works.work_id =
                              snapshot.data['data'][i]['work_id'].toString();

                          homeController.works.work_name =
                              snapshot.data['data'][i]['work_name'].toString();

                          homeController.works.work_description = snapshot
                              .data['data'][i]['work_description']
                              .toString();

                          homeController.works.work_image =
                              snapshot.data['data'][i]['work_image'].toString();

                          homeController.works.work_copmany = snapshot
                              .data['data'][i]['work_company']
                              .toString();

                          homeController.works.work_number_phone = snapshot
                              .data['data'][i]['work_number_phone']
                              .toString();

                          homeController.works.work_type =
                              snapshot.data['data'][i]['work_type'].toString();

                          homeController.works.work_place =
                              snapshot.data['data'][i]['work_place'].toString();

                          homeController.works.work_date =
                              snapshot.data['data'][i]['work_date'].toString();
